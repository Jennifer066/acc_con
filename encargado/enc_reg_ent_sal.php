            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
						...
						<form class="mt33" action="enc_reg_ent_sal2.php" method = "get">


								<div class="form-group row">
									<label for="description" class="control-label col-sm-3">Número de control:</label>
									<div class="col-sm-9">
									<input type="text" class="form-control" id="num_ctrl" name="num_ctrl" placeholder="Ingrese el número de control" required onKeyPress="function()">
									</div>
								</div>
						</form>
